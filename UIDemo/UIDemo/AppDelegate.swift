...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary?) -> Bool {
        ...
        // 代码在这里..
        // UIColor *c = [UColor redColor];
        let redColor:UIColor = UIColor.redColor();
        // :UIColor redColor UIColor对象
        self.window!.backgroundColor = redColor;
        
        // 创建一个导航控制
        let rvc = RootViewController();
        // [RootViewControlleRootViewController alloc] init];
//        let rvc = RootViewController(nibName:nil, bundle:nil);
        // alloc] init];
        let nav = UINavigationController(rootViewController:rvc);
        // UINavigationController alloc] initWithRoot
        // UINavigationController里面的构造方法 init(rootViewController
